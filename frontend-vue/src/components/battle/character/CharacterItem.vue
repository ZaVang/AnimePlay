...
<template>
  <div
    class="character-item relative w-20 h-28 rounded-lg overflow-hidden transition-all duration-300 transform"
    :class="{ 
  ...
  >
    <img :src="character.image_path" :alt="character.name" class="w-full h-full object-cover">

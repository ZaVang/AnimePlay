...
const battleMechanics = computed(() => [
  ...
  {
    title: 'TP系统',
    content: '每回合开始时，双方TP恢复到上限。TP上限 = 2 + (回合数 - 1)，逐回合增长、无上限封顶'
  },
  {
    title: '手牌补充',
...
const battleResults = computed(() => [
  ...
  },
  {
    ...
    outcomes: [
      '压倒性优势(≥5)：守方 -6 声望，议题→攻方 +3',
      '轻微优势(1~4)：守方 -5 声望，议题→攻方 +2',
      '平局(0)：议题→攻方 +1',
      '轻微劣势(-1~-4)：攻方 -5 声望',
      '压倒性劣势(≤-5)：攻方 -6 声望，议题→攻方 +1'
    ]
  },
  {
  ...
  },
  {
    ...
    outcomes: [
      '压倒性优势(≥5)：守方 -7 声望，议题→攻方 +3',
      '轻微优势(1~4)：守方 -6 声望，议题→攻方 +2',
      '平局(0)：无变化',
      '轻微劣势(-1~-4)：攻方 -4 声望',
      '压倒性劣势(≤-5)：攻方 -5 声望'
    ]

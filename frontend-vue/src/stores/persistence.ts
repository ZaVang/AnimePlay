...
export function buildPayload(): SavePayload {
  ...
  return {
    ...
    facility: useFacilityStore().serialize(),
    furniture: useFurnitureStore().serialize(),
  };
}
...
export function applyPayload(payload: SavePayload) {
  ...
  useFacilityStore().deserialize(payload.facility);
  useFurnitureStore().deserialize(payload.furniture);
...
export function resetAllDomains() {
  ...
  useFacilityStore().reset();
  useFurnitureStore().reset();
